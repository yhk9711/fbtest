    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        high.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), com.example.fbtest.HighActivity.class);
        ...
        medi.setOnClickListener(new  View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), com.example.fbtest.MediActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        low.setOnClickListener(new  View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), com.example.fbtest.LowActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        friendlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HomeTrainActivity.this, com.example.fbtest.FriendListActivity.class);
